'use client';
import { useEffect, useState, useCallback, type SVGAttributes } from 'react';
...
function MoonIcon(props: SVGAttributes<SVGElement>) {
  return (
    <svg
...
function SunIcon(props: SVGAttributes<SVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={16}
